...
export class App extends ReactiveComponent {
	constructor () {
		...
		this.buyAmount = new Bond;
		this.sellAmount = new Bond;
	}
		...
		return (<div>
				...
				<Header as='h2'>
  				...
  				<div style={{paddingBottom: '1em'}}>
					...
					<If condition={this.lookup.ready()} then={<div>
						...
						<Label>BondedToken Balance
							<Label.Detail>
								<Pretty value={runtime.bondedToken.balanceOf(this.lookup)}/>
							</Label.Detail>
						</Label>
					</div>}/>
				</div>
			...
			<Segment style={{margin: '1em'}} padded>
				<Header as='h2'>
					...
					<Header.Content>
						Bonded Token
						<Header.Subheader>Interact with the Bonded Token module</Header.Subheader>
					</Header.Content>
				</Header>
				<div style={{paddingBottom: '1em'}}></div>
				<Label>Reserve
					<Label.Detail>
						<Pretty value={runtime.bondedToken.reserve}/>
					</Label.Detail>
				</Label>
				<Label>Total Supply
					<Label.Detail>
						<Pretty value={runtime.bondedToken.totalSupply}/>
					</Label.Detail>
				</Label>
				<Label>Exponent
					<Label.Detail>
						<Pretty value={runtime.bondedToken.exponent}/>
					</Label.Detail>
				</Label>
				<Label>Slope
					<Label.Detail>
						<Pretty value={runtime.bondedToken.slope}/>
					</Label.Detail>
				</Label>
				<div style={{paddingBottom: '1em'}}></div>
				<TransactButton
					content="Create Tokens"
					icon='circle outline'
					tx={{
						sender: runtime.sudo.key,
						call: calls.bondedToken.createTokens(1000)
					}}
				/>
				<TransactButton
					content="Clear"
					...
					tx={{
						sender: runtime.sudo.key,
						call: calls.bondedToken.clearStorage()
					}}
				/>
				<TransactButton
					content="Initialize"
					...
					tx={{
						sender: runtime.sudo.key,
						call: calls.bondedToken.init(1, 1),
					}}
				/>
				<div style={{paddingBottom: '1em'}}>
					<div style={{fontSize: 'small'}}>Buy</div>
					<BalanceBond bond={this.buyAmount}/>
					<TransactButton
						content="Buy Tokens"
						tx={{
							sender: runtime.sudo.key,
							call: calls.bondedToken.buy(this.buyAmount)
						}}
					/>
				</div>
				<div style={{paddingBottom: '1em'}}>
					<div style={{fontSize: 'small'}}>Sell</div>
					<BalanceBond bond={this.sellAmount}/>
					<TransactButton
						content="Sell Tokens"
						tx={{
							sender: runtime.sudo.key,
							call: calls.bondedToken.sell(this.sellAmount)
						}}
					/>
				</div>
			</Segment>
